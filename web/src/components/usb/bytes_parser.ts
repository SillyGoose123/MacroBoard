...
function parseTone(raw: UsbData, pointer: number): Tone {
  switch (getByte(raw, pointer)) {
    case Tone.low.valueOf():
      return Tone.low;
    case Tone.medium.valueOf():
      return Tone.medium;
    case Tone.high.valueOf():
      return Tone.high;
    default:
      return Tone.high;
  }
